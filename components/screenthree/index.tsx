      ...
      <div className="row">
        ...
        <div className='col-lg-8 w-100' >
          ...
          <div className="col-12 form-group " >
              <input type="text" className="form-control p-3 rounded mb-3  bg-white text-dark" placeholder="Your Full Name " required style={{"width":"120%"}}/>
            </div>
        <br />
        <div className="col-12 form-group " >
              <input type="email" className="form-control p-3 rounded mb-3  bg-white text-dark" placeholder="Your Email "  required  style={{"width":"120%"}}/>
            </div>
            <br />
            <div className="col-12 form-group " >
